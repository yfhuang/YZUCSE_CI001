...
This folder collects reusable study notes and AI prompt templates for UVa/CPE preparation. The supplements are arranged in a recommended learning order, from C++ foundations to data structures, STL, algorithms, targeted UVa case studies, and exam strategy.
...
- [Supplement_09_Learning_Algorithm.md](./Supplement_09_Learning_Algorithm.md) - Practice core algorithmic approaches such as dynamic programming, greedy, and divide and conquer.
- [Supplement_10_UVa_11063_B2-Sequence.md](./Supplement_10_UVa_11063_B2-Sequence.md) - Analyze UVa 11063 (B2-Sequence) with multiple solution strategies and data-structure trade-offs.

## Suggested Study Sequence

1. Start with Supplement 01 for language background and learning context.
2. Read Supplement 07 to build data structure foundations.
3. Read Supplement 08 to become fluent with STL containers and algorithms.
4. Read Supplement 09 to learn core problem-solving strategies.
5. Study Supplement 10 to see how multiple solution strategies apply to a real UVa problem.
6. Use Supplement 04 to strengthen input-pattern recognition before coding.
7. Build your reusable toolkit with Supplement 05.
8. Use Supplement 06 to choose implementation style (iteration vs recursion).
9. Use Supplement 03 to review completed solutions and improve code quality.
10. Revisit Supplement 02 before mock tests and the actual CPE examination.

## Suggested Workflow

- **Foundation stage:** Supplements 01, 07, 08, and 09.
- **Practice stage:** Supplements 04, 05, 06, and 10.
